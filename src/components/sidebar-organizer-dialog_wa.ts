import { HA_EVENT, NAMESPACE_TITLE, REPO_URL } from '@constants';
...
@safeCustomElement('sidebar-organizer-dialog-wa')
  ...
  static get styles(): CSSResultGroup {
    return [
      css`
        ...
        .content {
          --so-dialog-content-height: calc(var(--mdc-dialog-min-height, 92vh) - 64px);
