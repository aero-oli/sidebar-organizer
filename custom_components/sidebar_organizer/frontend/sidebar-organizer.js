 ...
 */Qn((e,t)=>[{title:pg[e]||e,type:"expandable",expanded:!0,flatten:!1,required:!1,name:e,helper:mg[e]||"",schema:[{name:"",selector:{object:{label_field:"name",description_field:"value",multiple:!0,fields:{name:{label:gg[e]||"Name",selector:t,required:!1},value:{label:"Visibility Template",selector:{template:{preview:!0}},required:!1}}}}}]}]);const _g=e=>e?vo(e.trim()):"Ungrouped";let bg=class extends Yp{constructor(){super(d.NEW_ITEMS),this._selectedItemIndex=null,this._selectedItem=null,this._yamlMode=!1,this._actionsSchema=[{title:"Interaction",type:"expandable",flatten:!0,iconPath:Dp,schema:[{name:"entity",selector:{entity:{}},helper:"Entity to control when the button is pressed"},...fg()]}],this._notificationSchema=[{type:"expandable",title:"Notification badge template",iconPath:Hp,expanded:!1,schema:[{name:"notification",selector:{template:{}}}]}],this._configSchema=To(e=>[{type:"grid",schema:[{name:"icon",label:"Item Icon",selector:{icon:{}}},{name:"group",label:"Item Group",required:!1,selector:{select:{mode:"dropdown",options:e.length?e:[{value:"",label:"Ungrouped"}]}}}]}]),this._computeLabel=e=>{if("entity"===e.name&&!e.context?.group_entity)return;return vo((e.label||e.name||e.title||"").replace(/_/g," "))},this._computeHelper=e=>e.helper||void 0,this._handleDeleteItem=async e=>{const t=this._sidebarConfig.new_items[e].title;if(!await ou(this,`Are you sure you want to delete the item "${t}"?`,"Delete"))return;const i=[...this._sidebarConfig.new_items||[]];i.splice(e,1),this._sidebarConfig={...this._sidebarConfig,new_items:i},this._handleRemoveItem(t),this._dispatchConfig(this._sidebarConfig),this.requestUpdate()},this._handleRemoveItem=e=>{const t=this.getGroupKey(e);if(t){const i=t=>{const i=t.indexOf(e);-1!==i&&t.splice(i,1)},n={...this._sidebarConfig},o={...n};if("bottom_items"===t){const e=[...n.bottom_items||[]];i(e),o.bottom_items=e}else{const e={...n.custom_groups},s=e[t]||[];i(s),e[t]=s,o.custom_groups=e}this._sidebarConfig=o}},this._toggleRenameItem=async e=>{const t=this._sidebarConfig.new_items[e].title;let i=await su(this,"Enter new item title","Rename Item","Rename","Cancel");if(!i||""===i)return;if(i=i.trim(),this._sidebarConfig.new_items?.some(e=>e.title===i))return void await ou(this,"Item with this name already exists. Do you want to edit it?","Edit","Cancel");const n=this.getGroupKey(t);if(n){const e={...this._sidebarConfig};if("bottom_items"===n){const n=[...this._sidebarConfig.bottom_items||[]],o=n.indexOf(t);-1!==o&&(n[o]=i),e.bottom_items=n}else{const o={...this._sidebarConfig.custom_groups},s=o[n]||[],r=s.indexOf(t);-1!==r&&(s[r]=i),o[n]=s,e.custom_groups=o}this._sidebarConfig=e}const o=[...this._sidebarConfig.new_items||[]];o[e]={...o[e],title:i},this._sidebarConfig={...this._sidebarConfig,new_items:o},this._dispatchConfig(this._sidebarConfig),this._selectedItemIndex=e,this.requestUpdate()},this._togglePromptNewItem=async()=>{let e=await su(this,"Enter new item title","New Item","Add","Cancel");if(!e||""===e)return;if(e=e.trim(),this._sidebarConfig.new_items?.some(t=>t.title===e))return void await ou(this,"Item with this name already exists. Do you want to edit it?","Edit","Cancel");const t={title:e,icon:`mdi:alpha-${e.charAt(0).toLowerCase()}-circle`},i=[...this._sidebarConfig.new_items||[]];i.push(t),this._sidebarConfig={...this._sidebarConfig,new_items:i},this._dispatchConfig(this._sidebarConfig),this._selectedItemIndex=i.length-1,this.requestUpdate()}}firstUpdated(e){super.firstUpdated(e)}updated(e){super.updated(e),e.has("_selectedItemIndex")&&(null!==this._selectedItemIndex?(this._selectedItem=this._sidebarConfig.new_items[this._selectedItemIndex],this._toggleItemInPreview(this._selectedItem.title)):(this._selectedItem=null,this._yamlMode=!1,this._dialog._dialogPreview._hightlightItem(null)))}get groupKeys(){const e=this._sidebarConfig?.custom_groups||{};return[{value:"bottom_items",label:"BOTTOM"},...Object.keys(e).map(e=>({value:e,label:e.replace(/_/g," ").toUpperCase()}))]}render(){if(!this.hass||!this._sidebarConfig)return Xe`<div>Loading...</div>`;const e=this._renderNewItemsList(),t=this._renderSelectedItem();return Xe` <div class="config-content">${null===this._selectedItemIndex?e:t}</div> `}_renderNewItemsList(){if(null!==this._selectedItemIndex)return Qe;const e=Xe` <ha-button size="small" @click=${this._togglePromptNewItem}>Add new item </ha-button> `,t=this._sidebarConfig?.new_items||[],i=Xe`
                    ...
                    <div class="group-item-row" style="padding-inline-start: 1rem">
                      <div class="group-name" @click=${()=>this._selectedItemIndex=t}>
                        ...
                        <div class="group-name-items">
                          ${n}
                          <span>${_g(this.getGroupKey(n))}</span>
                        </div>
                      </div>
    ...
    </div>`,n={...t},o=this.getGroupKey(t.title),s=_g(o),r={icon:n?.icon,group:o},a=_o(n,["entity","tap_action","hold_action","double_tap_action"]),l={notification:n.notification},c=this.groupKeys,d=this._configSchema(c),h=this._actionsSchema,u=this._notificationSchema;return Xe`
      ${i}
      <div class="config-content">
        ${this._yamlMode?Xe`
              <ha-yaml-editor
    ...
    `}_valueChanged(e){if(e.stopPropagation(),null===this._selectedItemIndex)return;const t=this._selectedItemIndex,i={...this._sidebarConfig.new_items[t]},n=e.detail.value,o=e.target.configKey;let s={};if("base"===o){const e=n?.group,t=i.title;s={...n},this._handleGroupChange(t,e)}else if("actions"===o){const e=_o(i,["entity","tap_action","hold_action","double_tap_action"]);JSON.stringify(e)!==JSON.stringify(n)&&(s={...n})}else"notification"===o&&JSON.stringify(i.notification)!==JSON.stringify(n.notification)&&(s={notification:n.notification});if(Object.keys(s).length>0){const e={...i,...s},n=[...this._sidebarConfig.new_items||[]];n[t]=e,this._sidebarConfig={...this._sidebarConfig,new_items:n},this._selectedItem={...e},this._dispatchConfig(this._sidebarConfig)}}_handleGroupChange(e,t){const i=this.getGroupKey(e);if(!(i===t||""===i&&!t||!i&&!t||"bottom_items"===i&&"bottom"===t))if(t&&""!==t){if(i!==t){if(this._handleRemoveItem(e),"bottom"===t){const t=[...this._sidebarConfig.bottom_items||[]];return void(t.includes(e)||(t.push(e),this._sidebarConfig={...this._sidebarConfig,bottom_items:t}))}const i={...this._sidebarConfig.custom_groups};return i[t]||(i[t]=[]),i[t].push(e),void(this._sidebarConfig={...this._sidebarConfig,custom_groups:i})}}else this._handleRemoveItem(e)}_dispatchConfig(e){const t=new CustomEvent("sidebar-changed",{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(t)}static get styles(){return[super.styles,ue`
      ...
      `]}};Jd([ih({attribute:!1})],bg.prototype,"_sidebarConfig",void 0),Jd([nh()],bg.prototype,"_selectedItemIndex",void 0),Jd([nh()],bg.prototype,"_selectedItem",void 0),Jd([nh()],bg.prototype,"_yamlMode",void 0),bg=Jd([Qd("sidebar-dialog-new-items")],bg);
/*!
 * iro.js v5.5.2
 ...
 */
var yg,vg,wg,Eg,Ag,Og={},Sg=[],Cg=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;function Ig(e,t){for(var i in t)e[i]=t[i];return e}function xg(e){var t=e.parentNode;t&&t.removeChild(e)}function Tg(e,t,i){var n,o,s,r,a=arguments;if(t=Ig({},t),arguments.length>3)for(i=[i],n=3;n<arguments.length;n++)i.push(a[n]);if(null!=i&&(t.children=i),null!=e&&null!=e.defaultProps)for(o in e.defaultProps)void 0===t[o]&&(t[o]=e.defaultProps[o]);return r=t.key,null!=(s=t.ref)&&delete t.ref,null!=r&&delete t.key,kg(e,t,r,s)}function kg(e,t,i,n){var o={type:e,props:t,key:i,ref:n,__k:null,__p:null,__b:0,__e:null,l:null,__c:null,constructor:void 0};return yg.vnode&&yg.vnode(o),o}function Ng(e){return e.children}function $g(e){if(null==e||"boolean"==typeof e)return null;if("string"==typeof e||"number"==typeof e)return kg(null,e,null,null);if(null!=e.__e||null!=e.__c){var t=kg(e.type,e.props,e.key,null);return t.__e=e.__e,t}return e}function Lg(e,t){this.props=e,this.context=t}function Dg(e,t){if(null==t)return e.__p?Dg(e.__p,e.__p.__k.indexOf(e)+1):null;for(var i;t<e.__k.length;t++)if(null!=(i=e.__k[t])&&null!=i.__e)return i.__e;return"function"==typeof e.type?Dg(e):null}function Rg(e){var t,i;if(null!=(e=e.__p)&&null!=e.__c){for(e.__e=e.__c.base=null,t=0;t<e.__k.length;t++)if(null!=(i=e.__k[t])&&null!=i.__e){e.__e=e.__c.base=i.__e;break}return Rg(e)}}function Mg(e){(!e.__d&&(e.__d=!0)&&1===vg.push(e)||Eg!==yg.debounceRendering)&&(Eg=yg.debounceRendering,(yg.debounceRendering||wg)(Pg))}function Pg(){var e,t,i,n,o,s,r,a;for(vg.sort(function(e,t){return t.__v.__b-e.__v.__b});e=vg.pop();)e.__d&&(i=void 0,n=void 0,s=(o=(t=e).__v).__e,r=t.__P,a=t.u,t.u=!1,r&&(i=[],n=Vg(r,o,Ig({},o),t.__n,void 0!==r.ownerSVGElement,null,i,a,null==s?Dg(o):s),zg(i,o),n!=s&&Rg(o)))}function Hg(e,t,i,n,o,s,r,a,l){var c,d,h,u,f,p,g,m=i&&i.__k||Sg,_=m.length;if(a==Og&&(a=null!=s?s[0]:_?Dg(i,0):null),c=0,t.__k=Gg(t.__k,function(i){if(null!=i){if(i.__p=t,i.__b=t.__b+1,null===(h=m[c])||h&&i.key==h.key&&i.type===h.type)m[c]=void 0;else for(d=0;d<_;d++){if((h=m[d])&&i.key==h.key&&i.type===h.type){m[d]=void 0;break}h=null}if(u=Vg(e,i,h=h||Og,n,o,s,r,null,a,l),(d=i.ref)&&h.ref!=d&&(g||(g=[])).push(d,i.__c||u,i),null!=u){if(null==p&&(p=u),null!=i.l)u=i.l,i.l=null;else if(s==h||u!=a||null==u.parentNode){e:if(null==a||a.parentNode!==e)e.appendChild(u);else{for(f=a,d=0;(f=f.nextSibling)&&d<_;d+=2)if(f==u)break e;e.insertBefore(u,a)}"option"==t.type&&(e.value="")}a=u.nextSibling,"function"==typeof t.type&&(t.l=u)}}return c++,i}),t.__e=p,null!=s&&"function"!=typeof t.type)for(c=s.length;c--;)null!=s[c]&&xg(s[c]);for(c=_;c--;)null!=m[c]&&Wg(m[c],m[c]);if(g)for(c=0;c<g.length;c++)Kg(g[c],g[++c],g[++c])}function Gg(e,t,i){if(null==i&&(i=[]),null==e||"boolean"==typeof e)t&&i.push(t(null));else if(Array.isArray(e))for(var n=0;n<e.length;n++)Gg(e[n],t,i);else i.push(t?t($g(e)):e);return i}function Bg(e,t,i,n,o){var s;for(s in i)s in t||Ug(e,s,null,i[s],n);for(s in t)o&&"function"!=typeof t[s]||"value"===s||"checked"===s||i[s]===t[s]||Ug(e,s,t[s],i[s],n)}function jg(e,t,i){"-"===t[0]?e.setProperty(t,i):e[t]="number"==typeof i&&!1===Cg.test(t)?i+"px":null==i?"":i}function Ug(e,t,i,n,o){var s,r,a,l,c;if("key"===(t=o?"className"===t?"class":t:"class"===t?"className":t)||"children"===t);else if("style"===t)if(s=e.style,"string"==typeof i)s.cssText=i;else{if("string"==typeof n&&(s.cssText="",n=null),n)for(r in n)i&&r in i||jg(s,r,"");if(i)for(a in i)n&&i[a]===n[a]||jg(s,a,i[a])}else"o"===t[0]&&"n"===t[1]?(l=t!==(t=t.replace(/Capture$/,"")),c=t.toLowerCase(),t=(c in e?c:t).slice(2),i?(n||e.addEventListener(t,Fg,l),(e.t||(e.t={}))[t]=i):e.removeEventListener(t,Fg,l)):"list"!==t&&"tagName"!==t&&"form"!==t&&!o&&t in e?e[t]=null==i?"":i:"function"!=typeof i&&"dangerouslySetInnerHTML"!==t&&(t!==(t=t.replace(/^xlink:?/,""))?null==i||!1===i?e.removeAttributeNS("http://www.w3.org/1999/xlink",t.toLowerCase()):e.setAttributeNS("http://www.w3.org/1999/xlink",t.toLowerCase(),i):null==i||!1===i?e.removeAttribute(t):e.setAttribute(t,i))}function Fg(e){return this.t[e.type](yg.event?yg.event(e):e)}function Vg(e,t,i,n,o,s,r,a,l,c){var d,h,u,f,p,g,m,_,b,y,v=t.type;if(void 0!==t.constructor)return null;(d=yg.__b)&&d(t);try{e:if("function"==typeof v){if(_=t.props,b=(d=v.contextType)&&n[d.__c],y=d?b?b.props.value:d.__p:n,i.__c?m=(h=t.__c=i.__c).__p=h.__E:("prototype"in v&&v.prototype.render?t.__c=h=new v(_,y):(t.__c=h=new Lg(_,y),h.constructor=v,h.render=Yg),b&&b.sub(h),h.props=_,h.state||(h.state={}),h.context=y,h.__n=n,u=h.__d=!0,h.__h=[]),null==h.__s&&(h.__s=h.state),null!=v.getDerivedStateFromProps&&Ig(h.__s==h.state?h.__s=Ig({},h.__s):h.__s,v.getDerivedStateFromProps(_,h.__s)),u)null==v.getDerivedStateFromProps&&null!=h.componentWillMount&&h.componentWillMount(),null!=h.componentDidMount&&r.push(h);else{if(null==v.getDerivedStateFromProps&&null==a&&null!=h.componentWillReceiveProps&&h.componentWillReceiveProps(_,y),!a&&null!=h.shouldComponentUpdate&&!1===h.shouldComponentUpdate(_,h.__s,y)){for(h.props=_,h.state=h.__s,h.__d=!1,h.__v=t,t.__e=null!=l?l!==i.__e?l:i.__e:null,t.__k=i.__k,d=0;d<t.__k.length;d++)t.__k[d]&&(t.__k[d].__p=t);break e}null!=h.componentWillUpdate&&h.componentWillUpdate(_,h.__s,y)}for(f=h.props,p=h.state,h.context=y,h.props=_,h.state=h.__s,(d=yg.__r)&&d(t),h.__d=!1,h.__v=t,h.__P=e,d=h.render(h.props,h.state,h.context),t.__k=Gg(null!=d&&d.type==Ng&&null==d.key?d.props.children:d),null!=h.getChildContext&&(n=Ig(Ig({},n),h.getChildContext())),u||null==h.getSnapshotBeforeUpdate||(g=h.getSnapshotBeforeUpdate(f,p)),Hg(e,t,i,n,o,s,r,l,c),h.base=t.__e;d=h.__h.pop();)h.__s&&(h.state=h.__s),d.call(h);u||null==f||null==h.componentDidUpdate||h.componentDidUpdate(f,p,g),m&&(h.__E=h.__p=null)}else t.__e=qg(i.__e,t,i,n,o,s,r,c);(d=yg.diffed)&&d(t)}catch(e){yg.__e(e,t,i)}return t.__e}function zg(e,t){for(var i;i=e.pop();)try{i.componentDidMount()}catch(e){yg.__e(e,i.__v)}yg.__c&&yg.__c(t)}function qg(e,t,i,n,o,s,r,a){var l,c,d,h,u=i.props,f=t.props;if(o="svg"===t.type||o,null==e&&null!=s)for(l=0;l<s.length;l++)if(null!=(c=s[l])&&(null===t.type?3===c.nodeType:c.localName===t.type)){e=c,s[l]=null;break}if(null==e){if(null===t.type)return document.createTextNode(f);e=o?document.createElementNS("http://www.w3.org/2000/svg",t.type):document.createElement(t.type),s=null}return null===t.type?u!==f&&(null!=s&&(s[s.indexOf(e)]=null),e.data=f):t!==i&&(null!=s&&(s=Sg.slice.call(e.childNodes)),d=(u=i.props||Og).dangerouslySetInnerHTML,h=f.dangerouslySetInnerHTML,a||(h||d)&&(h&&d&&h.__html==d.__html||(e.innerHTML=h&&h.__html||"")),Bg(e,f,u,o,a),t.__k=t.props.children,h||Hg(e,t,i,n,"foreignObject"!==t.type&&o,s,r,Og,a),a||("value"in f&&void 0!==f.value&&f.value!==e.value&&(e.value=null==f.value?"":f.value),"checked"in f&&void 0!==f.checked&&f.checked!==e.checked&&(e.checked=f.checked))),e}function Kg(e,t,i){try{"function"==typeof e?e(t):e.current=t}catch(e){yg.__e(e,i)}}function Wg(e,t,i){var n,o,s;if(yg.unmount&&yg.unmount(e),(n=e.ref)&&Kg(n,null,t),i||"function"==typeof e.type||(i=null!=(o=e.__e)),e.__e=e.l=null,null!=(n=e.__c)){if(n.componentWillUnmount)try{n.componentWillUnmount()}catch(e){yg.__e(e,t)}n.base=n.__P=null}if(n=e.__k)for(s=0;s<n.length;s++)n[s]&&Wg(n[s],t,i);null!=o&&xg(o)}function Yg(e,t,i){return this.constructor(e,i)}function Jg(e,t,i){var n,o,s;yg.__p&&yg.__p(e,t),o=(n=i===Ag)?null:t.__k,e=Tg(Ng,null,[e]),s=[],Vg(t,t.__k=e,o||Og,Og,void 0!==t.ownerSVGElement,o?null:Sg.slice.call(t.childNodes),s,!1,Og,n),zg(s,e)}function Xg(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function Zg(e,t,i){return t&&Xg(e.prototype,t),e}function Qg(){return Qg=Object.assign||function(e){for(var t=arguments,i=1;i<arguments.length;i++){var n=t[i];for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(e[o]=n[o])}return e},Qg.apply(this,arguments)}yg={},Lg.prototype.setState=function(e,t){var i=this.__s!==this.state&&this.__s||(this.__s=Ig({},this.state));("function"!=typeof e||(e=e(i,this.props)))&&Ig(i,e),null!=e&&this.__v&&(this.u=!1,t&&this.__h.push(t),Mg(this))},Lg.prototype.forceUpdate=function(e){this.__v&&(e&&this.__h.push(e),this.u=!0,Mg(this))},Lg.prototype.render=Ng,vg=[],wg="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Eg=yg.debounceRendering,yg.__e=function(e,t,i){for(var n;t=t.__p;)if((n=t.__c)&&!n.__p)try{if(n.constructor&&null!=n.constructor.getDerivedStateFromError)n.setState(n.constructor.getDerivedStateFromError(e));else{if(null==n.componentDidCatch)continue;n.componentDidCatch(e)}return Mg(n.__E=n)}catch(t){e=t}throw e},Ag=Og;var em="[-\\+]?\\d+%?",tm="[-\\+]?\\d*\\.\\d+%?",im="(?:"+tm+")|(?:"+em+")",nm="[\\s|\\(]+("+im+")[,|\\s]+("+im+")[,|\\s]+("+im+")\\s*\\)?",om="[\\s|\\(]+("+im+")[,|\\s]+("+im+")[,|\\s]+("+im+")[,|\\s]+("+im+")\\s*\\)?",sm=new RegExp("rgb"+nm),rm=new RegExp("rgba"+om),am=new RegExp("hsl"+nm),lm=new RegExp("hsla"+om),cm="^(?:#?|0x?)",dm="([0-9a-fA-F]{1})",hm="([0-9a-fA-F]{2})",um=new RegExp(cm+dm+dm+dm+"$"),fm=new RegExp(cm+dm+dm+dm+dm+"$"),pm=new RegExp(cm+hm+hm+hm+"$"),gm=new RegExp(cm+hm+hm+hm+hm+"$"),mm=2e3,_m=4e4,bm=Math.log,ym=Math.round,vm=Math.floor;function wm(e,t,i){return Math.min(Math.max(e,t),i)}function Em(e,t){var i=e.indexOf("%")>-1,n=parseFloat(e);return i?t/100*n:n}function Am(e){return parseInt(e,16)}function Om(e){return e.toString(16).padStart(2,"0")}var Sm=function(){function e(e,t){this.$={h:0,s:0,v:0,a:1},e&&this.set(e),this.onChange=t,this.initialValue=Qg({},this.$)}var t=e.prototype;return t.set=function(t){if("string"==typeof t)/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(t)?this.hexString=t:/^rgba?/.test(t)?this.rgbString=t:/^hsla?/.test(t)&&(this.hslString=t);else{if("object"!=typeof t)throw new Error("Invalid color value");t instanceof e?this.hsva=t.hsva:"r"in t&&"g"in t&&"b"in t?this.rgb=t:"h"in t&&"s"in t&&"v"in t?this.hsv=t:"h"in t&&"s"in t&&"l"in t?this.hsl=t:"kelvin"in t&&(this.kelvin=t.kelvin)}},t.setChannel=function(e,t,i){var n;this[e]=Qg({},this[e],((n={})[t]=i,n))},t.reset=function(){this.hsva=this.initialValue},t.clone=function(){return new e(this)},t.unbind=function(){this.onChange=void 0},e.hsvToRgb=function(e){var t=e.h/60,i=e.s/100,n=e.v/100,o=vm(t),s=t-o,r=n*(1-i),a=n*(1-s*i),l=n*(1-(1-s)*i),c=o%6,d=[l,n,n,a,r,r][c],h=[r,r,l,n,n,a][c];return{r:wm(255*[n,a,r,r,l,n][c],0,255),g:wm(255*d,0,255),b:wm(255*h,0,255)}},e.rgbToHsv=function(e){var t=e.r/255,i=e.g/255,n=e.b/255,o=Math.max(t,i,n),s=Math.min(t,i,n),r=o-s,a=0,l=o,c=0===o?0:r/o;switch(o){case s:a=0;break;case t:a=(i-n)/r+(i<n?6:0);break;case i:a=(n-t)/r+2;break;case n:a=(t-i)/r+4}return{h:60*a%360,s:wm(100*c,0,100),v:wm(100*l,0,100)}},e.hsvToHsl=function(e){var t=e.s/100,i=e.v/100,n=(2-t)*i,o=n<=1?n:2-n,s=o<1e-9?0:t*i/o;return{h:e.h,s:wm(100*s,0,100),l:wm(50*n,0,100)}},e.hslToHsv=function(e){var t=2*e.l,i=e.s*(t<=100?t:200-t)/100,n=t+i<1e-9?0:2*i/(t+i);return{h:e.h,s:wm(100*n,0,100),v:wm((t+i)/2,0,100)}},e.kelvinToRgb=function(e){var t,i,n,o=e/100;return o<66?(t=255,i=-155.25485562709179-.44596950469579133*(i=o-2)+104.49216199393888*bm(i),n=o<20?0:.8274096064007395*(n=o-10)-254.76935184120902+115.67994401066147*bm(n)):(t=351.97690566805693+.114206453784165*(t=o-55)-40.25366309332127*bm(t),i=325.4494125711974+.07943456536662342*(i=o-50)-28.0852963507957*bm(i),n=255),{r:wm(vm(t),0,255),g:wm(vm(i),0,255),b:wm(vm(n),0,255)}},e.rgbToKelvin=function(t){for(var i,n=t.r,o=t.b,s=mm,r=_m;r-s>.4;){i=.5*(r+s);var a=e.kelvinToRgb(i);a.b/a.r>=o/n?r=i:s=i}return i},Zg(e,[{key:"hsv",get:function(){var e=this.$;return{h:e.h,s:e.s,v:e.v}},set:function(e){var t=this.$;if(e=Qg({},t,e),this.onChange){var i={h:!1,v:!1,s:!1,a:!1};for(var n in t)i[n]=e[n]!=t[n];this.$=e,(i.h||i.s||i.v||i.a)&&this.onChange(this,i)}else this.$=e}},{key:"hsva",get:function(){return Qg({},this.$)},set:function(e){this.hsv=e}},{key:"hue",get:function(){return this.$.h},set:function(e){this.hsv={h:e}}},{key:"saturation",get:function(){return this.$.s},set:function(e){this.hsv={s:e}}},{key:"value",get:function(){return this.$.v},set:function(e){this.hsv={v:e}}},{key:"alpha",get:function(){return this.$.a},set:function(e){this.hsv=Qg({},this.hsv,{a:e})}},{key:"kelvin",get:function(){return e.rgbToKelvin(this.rgb)},set:function(t){this.rgb=e.kelvinToRgb(t)}},{key:"red",get:function(){return this.rgb.r},set:function(e){this.rgb=Qg({},this.rgb,{r:e})}},{key:"green",get:function(){return this.rgb.g},set:function(e){this.rgb=Qg({},this.rgb,{g:e})}},{key:"blue",get:function(){return this.rgb.b},set:function(e){this.rgb=Qg({},this.rgb,{b:e})}},{key:"rgb",get:function(){var t=e.hsvToRgb(this.$),i=t.r,n=t.g,o=t.b;return{r:ym(i),g:ym(n),b:ym(o)}},set:function(t){this.hsv=Qg({},e.rgbToHsv(t),{a:void 0===t.a?1:t.a})}},{key:"rgba",get:function(){return Qg({},this.rgb,{a:this.alpha})},set:function(e){this.rgb=e}},{key:"hsl",get:function(){var t=e.hsvToHsl(this.$),i=t.h,n=t.s,o=t.l;return{h:ym(i),s:ym(n),l:ym(o)}},set:function(t){this.hsv=Qg({},e.hslToHsv(t),{a:void 0===t.a?1:t.a})}},{key:"hsla",get:function(){return Qg({},this.hsl,{a:this.alpha})},set:function(e){this.hsl=e}},{key:"rgbString",get:function(){var e=this.rgb;return"rgb("+e.r+", "+e.g+", "+e.b+")"},set:function(e){var t,i,n,o,s=1;if((t=sm.exec(e))?(i=Em(t[1],255),n=Em(t[2],255),o=Em(t[3],255)):(t=rm.exec(e))&&(i=Em(t[1],255),n=Em(t[2],255),o=Em(t[3],255),s=Em(t[4],1)),!t)throw new Error("Invalid rgb string");this.rgb={r:i,g:n,b:o,a:s}}},{key:"rgbaString",get:function(){var e=this.rgba;return"rgba("+e.r+", "+e.g+", "+e.b+", "+e.a+")"},set:function(e){this.rgbString=e}},{key:"hexString",get:function(){var e=this.rgb;return"#"+Om(e.r)+Om(e.g)+Om(e.b)},set:function(e){var t,i,n,o,s=255;if((t=um.exec(e))?(i=17*Am(t[1]),n=17*Am(t[2]),o=17*Am(t[3])):(t=fm.exec(e))?(i=17*Am(t[1]),n=17*Am(t[2]),o=17*Am(t[3]),s=17*Am(t[4])):(t=pm.exec(e))?(i=Am(t[1]),n=Am(t[2]),o=Am(t[3])):(t=gm.exec(e))&&(i=Am(t[1]),n=Am(t[2]),o=Am(t[3]),s=Am(t[4])),!t)throw new Error("Invalid hex string");this.rgb={r:i,g:n,b:o,a:s/255}}},{key:"hex8String",get:function(){var e=this.rgba;return"#"+Om(e.r)+Om(e.g)+Om(e.b)+Om(vm(255*e.a))},set:function(e){this.hexString=e}},{key:"hslString",get:function(){var e=this.hsl;return"hsl("+e.h+", "+e.s+"%, "+e.l+"%)"},set:function(e){var t,i,n,o,s=1;if((t=am.exec(e))?(i=Em(t[1],360),n=Em(t[2],100),o=Em(t[3],100)):(t=lm.exec(e))&&(i=Em(t[1],360),n=Em(t[2],100),o=Em(t[3],100),s=Em(t[4],1)),!t)throw new Error("Invalid hsl string");this.hsl={h:i,s:n,l:o,a:s}}},{key:"hslaString",get:function(){var e=this.hsla;return"hsla("+e.h+", "+e.s+"%, "+e.l+"%, "+e.a+")"},set:function(e){this.hslString=e}}]),e}(),Cm={sliderShape:"bar",sliderType:"value",minTemperature:2200,maxTemperature:11e3};function Im(e){var t,i=e.width,n=e.sliderSize,o=e.borderWidth,s=e.handleRadius,r=e.padding,a=e.sliderShape,l="horizontal"===e.layoutDirection;return n=null!=(t=n)?t:2*r+2*s,"circle"===a?{handleStart:e.padding+e.handleRadius,handleRange:i-2*r-2*s,width:i,height:i,cx:i/2,cy:i/2,radius:i/2-o/2}:{handleStart:n/2,handleRange:i-n,radius:n/2,x:0,y:0,width:l?n:i,height:l?i:n}}function xm(e,t){var i=t.hsva,n=t.rgb;switch(e.sliderType){case"red":return n.r/2.55;case"green":return n.g/2.55;case"blue":return n.b/2.55;case"alpha":return 100*i.a;case"kelvin":var o=e.minTemperature,s=e.maxTemperature-o,r=(t.kelvin-o)/s*100;return Math.max(0,Math.min(r,100));case"hue":return i.h/=3.6;case"saturation":return i.s;default:return i.v}}function Tm(e,t,i){var n,o=Im(e),s=o.handleRange,r=o.handleStart;n="horizontal"===e.layoutDirection?-1*i+s+r:t-r,n=Math.max(Math.min(n,s),0);var a=Math.round(100/s*n);switch(e.sliderType){case"kelvin":var l=e.minTemperature;return l+(e.maxTemperature-l)*(a/100);case"alpha":return a/100;case"hue":return 3.6*a;case"red":case"blue":case"green":return 2.55*a;default:return a}}function km(e,t){var i=Im(e),n=i.width,o=i.height,s=i.handleRange,r=i.handleStart,a="horizontal"===e.layoutDirection,l=a?n/2:o/2,c=r+xm(e,t)/100*s;return a&&(c=-1*c+s+2*r),{x:a?l:c,y:a?c:l}}function Nm(e,t){var i=t.hsv,n=t.rgb;switch(e.sliderType){case"red":return[[0,"rgb(0,"+n.g+","+n.b+")"],[100,"rgb(255,"+n.g+","+n.b+")"]];case"green":return[[0,"rgb("+n.r+",0,"+n.b+")"],[100,"rgb("+n.r+",255,"+n.b+")"]];case"blue":return[[0,"rgb("+n.r+","+n.g+",0)"],[100,"rgb("+n.r+","+n.g+",255)"]];case"alpha":return[[0,"rgba("+n.r+","+n.g+","+n.b+",0)"],[100,"rgb("+n.r+","+n.g+","+n.b+")"]];case"kelvin":for(var o=[],s=e.minTemperature,r=e.maxTemperature,a=r-s,l=s,c=0;l<r;l+=a/8,c+=1){var d=Sm.kelvinToRgb(l),h=d.r,u=d.g,f=d.b;o.push([12.5*c,"rgb("+h+","+u+","+f+")"])}return o;case"hue":return[[0,"#f00"],[16.666,"#ff0"],[33.333,"#0f0"],[50,"#0ff"],[66.666,"#00f"],[83.333,"#f0f"],[100,"#f00"]];case"saturation":var p=Sm.hsvToHsl({h:i.h,s:0,v:i.v}),g=Sm.hsvToHsl({h:i.h,s:100,v:i.v});return[[0,"hsl("+p.h+","+p.s+"%,"+p.l+"%)"],[100,"hsl("+g.h+","+g.s+"%,"+g.l+"%)"]];default:var m=Sm.hsvToHsl({h:i.h,s:i.s,v:100});return[[0,"#000"],[100,"hsl("+m.h+","+m.s+"%,"+m.l+"%)"]]}}var $m,Lm=2*Math.PI,Dm=function(e,t){return(e%t+t)%t},Rm=function(e,t){return Math.sqrt(e*e+t*t)};function Mm(e){return e.width/2-e.padding-e.handleRadius-e.borderWidth}function Pm(e,t,i){var n=Hm(e),o=n.cx,s=n.cy,r=e.width/2;return Rm(o-t,s-i)<r}function Hm(e){var t=e.width/2;return{width:e.width,radius:t-e.borderWidth,cx:t,cy:t}}function Gm(e,t,i){var n=e.wheelAngle,o=e.wheelDirection;return i&&"clockwise"===o?t=n+t:"clockwise"===o?t=360-n+t:i&&"anticlockwise"===o?t=n+180-t:"anticlockwise"===o&&(t=n-t),Dm(t,360)}function Bm(e,t){var i=t.hsv,n=Hm(e),o=n.cx,s=n.cy,r=Mm(e),a=(180+Gm(e,i.h,!0))*(Lm/360),l=i.s/100*r,c="clockwise"===e.wheelDirection?-1:1;return{x:o+l*Math.cos(a)*c,y:s+l*Math.sin(a)*c}}function jm(e,t,i){var n=Hm(e),o=n.cx,s=n.cy,r=Mm(e);t=o-t,i=s-i;var a=Gm(e,Math.atan2(-i,-t)*(360/Lm)),l=Math.min(Rm(t,i),r);return{h:Math.round(a),s:Math.round(100/r*l)}}function Um(e){var t=e.width,i=e.boxHeight;return{width:t,height:null!=i?i:t,radius:e.padding+e.handleRadius}}function Fm(e,t,i){var n=Um(e),o=n.width,s=n.height,r=n.radius,a=(t-r)/(o-2*r)*100,l=(i-r)/(s-2*r)*100;return{s:Math.max(0,Math.min(a,100)),v:Math.max(0,Math.min(100-l,100))}}function Vm(e,t){var i=Um(e),n=i.width,o=i.height,s=i.radius,r=t.hsv,a=s,l=n-2*s,c=o-2*s;return{x:a+r.s/100*l,y:a+(c-r.v/100*c)}}function zm(e,t){return[[[0,"#fff"],[100,"hsl("+t.hue+",100%,50%)"]],[[0,"rgba(0,0,0,0)"],[100,"#000"]]]}function qm(e){$m||($m=document.getElementsByTagName("base"));var t=window.navigator.userAgent,i=/^((?!chrome|android).)*safari/i.test(t),n=/iPhone|iPod|iPad/i.test(t),o=window.location;return(i||n)&&$m.length>0?o.protocol+"//"+o.host+o.pathname+o.search+e:e}function Km(e,t,i,n){for(var o=0;o<n.length;o++){var s=n[o].x-t,r=n[o].y-i;if(Math.sqrt(s*s+r*r)<e.handleRadius)return o}return null}function Wm(e){return{boxSizing:"border-box",border:e.borderWidth+"px solid "+e.borderColor}}function Ym(e,t,i){return e+"-gradient("+t+", "+i.map(function(e){var t=e[0];return e[1]+" "+t+"%"}).join(",")+")"}function Jm(e){return"string"==typeof e?e:e+"px"}var Xm={width:300,height:300,color:"#fff",colors:[],padding:6,layoutDirection:"vertical",borderColor:"#fff",borderWidth:0,handleRadius:8,activeHandleRadius:null,handleSvg:null,handleProps:{x:0,y:0},wheelLightness:!0,wheelAngle:0,wheelDirection:"anticlockwise",sliderSize:null,sliderMargin:12,boxHeight:null},Zm=["mousemove","touchmove","mouseup","touchend"],Qm=function(e){function t(t){e.call(this,t),this.uid=(Math.random()+1).toString(36).substring(5)}return e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t,t.prototype.render=function(e){var t=this.handleEvent.bind(this),i={onMouseDown:t,ontouchstart:t},n="horizontal"===e.layoutDirection,o=null===e.margin?e.sliderMargin:e.margin,s={overflow:"visible",display:n?"inline-block":"block"};return e.index>0&&(s[n?"marginLeft":"marginTop"]=o),Tg(Ng,null,e.children(this.uid,i,s))},t.prototype.handleEvent=function(e){var t=this,i=this.props.onInput,n=this.base.getBoundingClientRect();e.preventDefault();var o=e.touches?e.changedTouches[0]:e,s=o.clientX-n.left,r=o.clientY-n.top;switch(e.type){case"mousedown":case"touchstart":!1!==i(s,r,0)&&Zm.forEach(function(e){document.addEventListener(e,t,{passive:!1})});break;case"mousemove":case"touchmove":i(s,r,1);break;case"mouseup":case"touchend":i(s,r,2),Zm.forEach(function(e){document.removeEventListener(e,t,{passive:!1})})}},t}(Lg);function e_(e){var t=e.r,i=e.url,n=t,o=t;return Tg("svg",{className:"IroHandle IroHandle--"+e.index+" "+(e.isActive?"IroHandle--isActive":""),style:{"-webkit-tap-highlight-color":"rgba(0, 0, 0, 0);",transform:"translate("+Jm(e.x)+", "+Jm(e.y)+")",willChange:"transform",top:Jm(-t),left:Jm(-t),width:Jm(2*t),height:Jm(2*t),position:"absolute",overflow:"visible"}},i&&Tg("use",Object.assign({xlinkHref:qm(i)},e.props)),!i&&Tg("circle",{cx:n,cy:o,r:t,fill:"none","stroke-width":2,stroke:"#000"}),!i&&Tg("circle",{cx:n,cy:o,r:t-2,fill:e.fill,"stroke-width":2,stroke:"#fff"}))}function t_(e){var t=e.activeIndex,i=void 0!==t&&t<e.colors.length?e.colors[t]:e.color,n=Im(e),o=n.width,s=n.height,r=n.radius,a=km(e,i),l=Nm(e,i);return Tg(Qm,Object.assign({},e,{onInput:function(t,n,o){var s=Tm(e,t,n);e.parent.inputActive=!0,i[e.sliderType]=s,e.onInput(o,e.id)}}),function(t,n,c){return Tg("div",Object.assign({},n,{className:"IroSlider",style:Object.assign({},{position:"relative",width:Jm(o),height:Jm(s),borderRadius:Jm(r),background:"conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)",backgroundSize:"8px 8px"},c)}),Tg("div",{className:"IroSliderGradient",style:Object.assign({},{position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:Jm(r),background:Ym("linear","horizontal"===e.layoutDirection?"to top":"to right",l)},Wm(e))}),Tg(e_,{isActive:!0,index:i.index,r:e.handleRadius,url:e.handleSvg,props:e.handleProps,x:a.x,y:a.y}))})}function i_(e){var t=Um(e),i=t.width,n=t.height,o=t.radius,s=e.colors,r=e.parent,a=e.activeIndex,l=void 0!==a&&a<e.colors.length?e.colors[a]:e.color,c=zm(e,l),d=s.map(function(t){return Vm(e,t)});return Tg(Qm,Object.assign({},e,{onInput:function(t,i,n){if(0===n){var o=Km(e,t,i,d);null!==o?r.setActiveColor(o):(r.inputActive=!0,l.hsv=Fm(e,t,i),e.onInput(n,e.id))}else 1===n&&(r.inputActive=!0,l.hsv=Fm(e,t,i));e.onInput(n,e.id)}}),function(t,r,a){return Tg("div",Object.assign({},r,{className:"IroBox",style:Object.assign({},{width:Jm(i),height:Jm(n),position:"relative"},a)}),Tg("div",{className:"IroBox",style:Object.assign({},{width:"100%",height:"100%",borderRadius:Jm(o)},Wm(e),{background:Ym("linear","to bottom",c[1])+","+Ym("linear","to right",c[0])})}),s.filter(function(e){return e!==l}).map(function(t){return Tg(e_,{isActive:!1,index:t.index,fill:t.hslString,r:e.handleRadius,url:e.handleSvg,props:e.handleProps,x:d[t.index].x,y:d[t.index].y})}),Tg(e_,{isActive:!0,index:l.index,fill:l.hslString,r:e.activeHandleRadius||e.handleRadius,url:e.handleSvg,props:e.handleProps,x:d[l.index].x,y:d[l.index].y}))})}e_.defaultProps={fill:"none",x:0,y:0,r:8,url:null,props:{x:0,y:0}},t_.defaultProps=Object.assign({},Cm);var n_="conic-gradient(red, yellow, lime, aqua, blue, magenta, red)",o_="conic-gradient(red, magenta, blue, aqua, lime, yellow, red)";function s_(e){var t=Hm(e).width,i=e.colors;e.borderWidth;var n=e.parent,o=e.color,s=o.hsv,r=i.map(function(t){return Bm(e,t)}),a={position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:"50%",boxSizing:"border-box"};return Tg(Qm,Object.assign({},e,{onInput:function(t,i,s){if(0===s){if(!Pm(e,t,i))return!1;var a=Km(e,t,i,r);null!==a?n.setActiveColor(a):(n.inputActive=!0,o.hsv=jm(e,t,i),e.onInput(s,e.id))}else 1===s&&(n.inputActive=!0,o.hsv=jm(e,t,i));e.onInput(s,e.id)}}),function(n,l,c){return Tg("div",Object.assign({},l,{className:"IroWheel",style:Object.assign({},{width:Jm(t),height:Jm(t),position:"relative"},c)}),Tg("div",{className:"IroWheelHue",style:Object.assign({},a,{transform:"rotateZ("+(e.wheelAngle+90)+"deg)",background:"clockwise"===e.wheelDirection?n_:o_})}),Tg("div",{className:"IroWheelSaturation",style:Object.assign({},a,{background:"radial-gradient(circle closest-side, #fff, transparent)"})}),e.wheelLightness&&Tg("div",{className:"IroWheelLightness",style:Object.assign({},a,{background:"#000",opacity:1-s.v/100})}),Tg("div",{className:"IroWheelBorder",style:Object.assign({},a,Wm(e))}),i.filter(function(e){return e!==o}).map(function(t){return Tg(e_,{isActive:!1,index:t.index,fill:t.hslString,r:e.handleRadius,url:e.handleSvg,props:e.handleProps,x:r[t.index].x,y:r[t.index].y})}),Tg(e_,{isActive:!0,index:o.index,fill:o.hslString,r:e.activeHandleRadius||e.handleRadius,url:e.handleSvg,props:e.handleProps,x:r[o.index].x,y:r[o.index].y}))})}function r_(e){var t=function(t,i){var n,o=document.createElement("div");function s(){var e=t instanceof Element?t:document.querySelector(t);e.appendChild(n.base),n.onMount(e)}return Jg(Tg(e,Object.assign({},{ref:function(e){return n=e}},i)),o),"loading"!==document.readyState?s():document.addEventListener("DOMContentLoaded",s),n};return t.prototype=e.prototype,Object.assign(t,e),t.__component=e,t}var a_=function(e){function t(t){var i=this;e.call(this,t),this.colors=[],this.inputActive=!1,this.events={},this.activeEvents={},this.deferredEvents={},this.id=t.id,(t.colors.length>0?t.colors:[t.color]).forEach(function(e){return i.addColor(e)}),this.setActiveColor(0),this.state=Object.assign({},t,{color:this.color,colors:this.colors,layout:t.layout})}return e&&(t.__proto__=e),t.prototype=Object.create(e&&e.prototype),t.prototype.constructor=t,t.prototype.addColor=function(e,t){void 0===t&&(t=this.colors.length);var i=new Sm(e,this.onColorChange.bind(this));this.colors.splice(t,0,i),this.colors.forEach(function(e,t){return e.index=t}),this.state&&this.setState({colors:this.colors}),this.deferredEmit("color:init",i)},t.prototype.removeColor=function(e){var t=this.colors.splice(e,1)[0];t.unbind(),this.colors.forEach(function(e,t){return e.index=t}),this.state&&this.setState({colors:this.colors}),t.index===this.color.index&&this.setActiveColor(0),this.emit("color:remove",t)},t.prototype.setActiveColor=function(e){this.color=this.colors[e],this.state&&this.setState({color:this.color}),this.emit("color:setActive",this.color)},t.prototype.setColors=function(e,t){var i=this;void 0===t&&(t=0),this.colors.forEach(function(e){return e.unbind()}),this.colors=[],e.forEach(function(e){return i.addColor(e)}),this.setActiveColor(t),this.emit("color:setAll",this.colors)},t.prototype.on=function(e,t){var i=this,n=this.events;(Array.isArray(e)?e:[e]).forEach(function(e){(n[e]||(n[e]=[])).push(t),i.deferredEvents[e]&&(i.deferredEvents[e].forEach(function(e){t.apply(null,e)}),i.deferredEvents[e]=[])})},t.prototype.off=function(e,t){var i=this;(Array.isArray(e)?e:[e]).forEach(function(e){var n=i.events[e];n&&n.splice(n.indexOf(t),1)})},t.prototype.emit=function(e){for(var t=this,i=[],n=arguments.length-1;n-- >0;)i[n]=arguments[n+1];var o=this.activeEvents;!!o.hasOwnProperty(e)&&o[e]||(o[e]=!0,(this.events[e]||[]).forEach(function(e){return e.apply(t,i)}),o[e]=!1)},t.prototype.deferredEmit=function(e){for(var t,i=[],n=arguments.length-1;n-- >0;)i[n]=arguments[n+1];var o=this.deferredEvents;(t=this).emit.apply(t,[e].concat(i)),(o[e]||(o[e]=[])).push(i)},t.prototype.setOptions=function(e){this.setState(e)},t.prototype.resize=function(e){this.setOptions({width:e})},t.prototype.reset=function(){this.colors.forEach(function(e){return e.reset()}),this.setState({colors:this.colors})},t.prototype.onMount=function(e){this.el=e,this.deferredEmit("mount",this)},t.prototype.onColorChange=function(e,t){this.setState({color:this.color}),this.inputActive&&(this.inputActive=!1,this.emit("input:change",e,t)),this.emit("color:change",e,t)},t.prototype.emitInputEvent=function(e,t){0===e?this.emit("input:start",this.color,t):1===e?this.emit("input:move",this.color,t):2===e&&this.emit("input:end",this.color,t)},t.prototype.render=function(e,t){var i=this,n=t.layout;return Array.isArray(n)||(n=[{component:s_},{component:t_}],t.transparency&&n.push({component:t_,options:{sliderType:"alpha"}})),Tg("div",{class:"IroColorPicker",id:t.id,style:{display:t.display}},n.map(function(e,n){var o=e.component,s=e.options;return Tg(o,Object.assign({},t,s,{ref:void 0,onInput:i.emitInputEvent.bind(i),parent:i,index:n}))}))},t}(Lg);a_.defaultProps=Object.assign({},Xm,{colors:[],display:"block",id:null,layout:"default",margin:null});var l_,c_=r_(a_);!function(e){var t;e.version="5.5.2",e.Color=Sm,e.ColorPicker=c_,(t=e.ui||(e.ui={})).h=Tg,t.ComponentBase=Qm,t.Handle=e_,t.Slider=t_,t.Wheel=s_,t.Box=i_}(l_||(l_={}));var d_,h_=l_;!function(e){e[e.LOADING=1]="LOADING",e[e.READY=2]="READY",e[e.ERROR=3]="ERROR"}(d_||(d_={}));let u_=class extends Yp{constructor(){super(d.APPEARANCE),this._picker=null,this._baseColorFromTheme={},this._state=d_.LOADING,this._initColor="",this._initCustomStyles={},this._supportedModes=[]}connectedCallback(){super.connectedCallback()}firstUpdated(e){if(super.firstUpdated(e),!this._sidebarConfig)return;const t=ie(this._sidebarConfig.color_config,this.hass);this._colorConfigMode=t?"dark":"light"}shouldUpdate(e){return!e.has("_colorConfigMode")||void 0===this._colorConfigMode||(this._setTheme(this._colorConfigMode),this._state=d_.LOADING,this._initCustomStyles={...this._sidebarConfig.color_config?.[this._colorConfigMode]?.custom_styles||{}},setTimeout(()=>{this._state=d_.READY},200),!0)}updated(e){if(super.updated(e),e.has("_currentConfigValue")&&void 0!==this._currentConfigValue?setTimeout(()=>{this._initColorPicker()},50):e.has("_currentConfigValue")&&void 0===this._currentConfigValue&&this._destroyColorPicker(),e.has("_state")&&this._state===d_.READY&&this._getYamlEditor(),e.has("_sidebarConfig")&&this._sidebarConfig){const t=e.get("_sidebarConfig")?.color_config?.custom_theme,i=this._sidebarConfig.color_config?.custom_theme;if(t&&i&&t.theme&&t.theme!==i.theme)if(this._supportsMode(i.theme)){const e=this._getSupportedModes(i.theme);this._supportedModes=e,1===e.length?this._colorConfigMode=e[0]:this._colorConfigMode=i.mode||(this.hass.themes.darkMode?"dark":"light")}else{const e=/dark/i,t=/light/i.test(i.theme),n=e.test(i.theme);this._colorConfigMode=t?"light":n||this.hass.themes.darkMode?"dark":"light",this._supportedModes=[]}t&&i&&t.mode!==i.mode&&(this._colorConfigMode=i.mode||(this.hass.themes.darkMode?"dark":"light"))}}_supportsMode(e){return e in this.hass.themes.themes&&(void 0!==this.hass.themes.themes[e].modes&&("modes"in this.hass.themes.themes[e]&&this.hass.themes.themes[e].modes&&Object.keys(this.hass.themes.themes[e].modes).length>0))}_getSupportedModes(e){return this._supportsMode(e)?Object.keys(this.hass.themes.themes[e].modes):[]}_getYamlEditor(){const e=this.shadowRoot?.querySelector("ha-yaml-editor");e&&(this._yamlEditor=e)}_getDefaultColors(){const e=this.shadowRoot?.getElementById("theme-container");if(!e)return;const t=tu(e);this._baseColorFromTheme=t}_destroyColorPicker(){this._picker=null;const e=this.shadowRoot?.querySelector(".picker-wrapper"),t=this.shadowRoot?.getElementById("picker");e&&t&&(e.setAttribute("hidden",""),t.innerHTML="")}_initColorPicker(){const e=void 0!==this._currentConfigValue,t=this.shadowRoot?.querySelector(".picker-wrapper"),i=this.shadowRoot?.getElementById("picker");if(!t||!i)return;t.toggleAttribute("hidden",!e);const n=this._colorConfigMode,o=this._sidebarConfig.color_config?.[n]||{},s=this._currentConfigValue,r=uh(o[s]||this._baseColorFromTheme[s]),a="hex"===r.getFormat()?r.toHex8String():r.toRgbString();this._initColor=o[s]??void 0,this._picker=h_.ColorPicker(i,{width:150,color:a,borderWidth:1,borderColor:"#fff",layoutDirection:"horizontal",layout:[{component:h_.ui.Wheel,options:{}},{component:h_.ui.Slider,options:{sliderType:"hue"}},{component:h_.ui.Slider,options:{sliderType:"saturation"}},{component:h_.ui.Slider,options:{sliderType:"value"}},{component:h_.ui.Slider,options:{sliderType:"alpha"}}]}),this._picker.on(["color:init","color:change"],e=>{this._currentConfigValue=s;const t=this._picker?.props.color,i="hex"===uh(t).getFormat()?e.hex8String:e.rgbaString;this._handleConfigChange(this._currentConfigValue,i)})}_handleConfigChange(e,t){const i=this._colorConfigMode,n={...this._sidebarConfig.color_config||{}},o={...n[i]||{}};o[e]=t,this._sidebarConfig={...this._sidebarConfig,color_config:{...n,[i]:o}},this._dispatchConfig(this._sidebarConfig)}_setTheme(e){const t=this._sidebarConfig?.color_config?.custom_theme?.theme||this.hass.themes.theme,i=this.shadowRoot?.getElementById("theme-container");Z(i,this.hass,t,e),setTimeout(()=>{this._getDefaultColors(),this._initCustomStyles=this._sidebarConfig.color_config?.[e]?.custom_styles||[]},0),this._dialog._dialogPreview&&this._dialog._dialogPreview._colorConfigMode!==e&&(this._dialog._dialogPreview._colorConfigMode=e)}render(){const e=_o({...this._sidebarConfig||{}},[...Y]);return Xe`
      <div id="theme-container" style="display: none;"></div>
      ${gu(this,lg(e),e,{configKey:"appearance"})}
    ...
    </div>`;return Xe`${gu(this,dg(2!==n.length),i,{configKey:"custom_theme"})}
    ...
    `}_renderCustomStylesField(){if(!this._sidebarConfig||!this._colorConfigMode)return Xe``;if(this._state===d_.LOADING)return Xe`<ha-fade-in .delay=${500}><ha-spinner size="large"></ha-spinner></ha-fade-in>`;const e=this._colorConfigMode,t=this._sidebarConfig?.color_config?.[e]?.custom_styles,i=!bo(t),n={custom_styles:this._initCustomStyles};return Xe`
      ...
      ${e.length?Xe`
            <ha-sortable handle-selector=".handle" @item-moved=${this._groupMoved}>
              <div class="group-list" id="group-list">
                ${sg(e,e=>e,(e,i)=>this._renderCustomGroupRow(e,i,t))}
              </div>
              ${this._renderSpacer()}
            </ha-sortable>
    ...
    `}_renderSelectedItems(e,t){const i=this.hass?.panels,n=e=>this._dialog._newItemMap.get(e)?.icon||i[e]?.icon||"",o=t.map(e=>({key:e,title:this.hass.localize(`panel.${i[e]?.title}`)||i[e]?.title||i[e]?.url_path||e,icon:n(e)})),s=e.replace(/_/g," ").toUpperCase();return Xe`
      <div class="header-row flex-icon">
        ...
        <ha-icon-button .path=${jp} @click=${()=>this._sortItems(e)}>
        </ha-icon-button>
      </div>
    ...
    `}_renderSpacer(){return Xe`<div style="flex: 1"></div>`}_sortItems(e){const t=this.hass?.panels,i=(e===m.BOTTOM_ITEMS||e===m.BOTTOM_GRID_ITEMS?this._sidebarConfig[e]||[]:this._sidebarConfig.custom_groups?.[e]||[]).map(e=>({key:e,title:this.hass.localize(`panel.${t[e]?.title}`)||t[e]?.title||t[e]?.url_path||e})),n=[...i].sort((e,t)=>{const i=e.title.toUpperCase(),n=t.title.toUpperCase();return i.localeCompare(n)});let o;o=i.every((e,t)=>e.key===n[t].key)?[...i].sort((e,t)=>{const i=e.title.toUpperCase();return t.title.toUpperCase().localeCompare(i)}):n;const s=o.map(e=>e.key),r={};if(e===m.BOTTOM_ITEMS||e===m.BOTTOM_GRID_ITEMS){const t=e;let i=[...this._sidebarConfig[t]||[]];i=s,r[t]=i}else{let t={...this._sidebarConfig.custom_groups||{}},i=[...t[e]||[]];i=s,t[e]=i,r.custom_groups=t}Object.keys(r).length>0&&(this._sidebarConfig={...this._sidebarConfig,...r},this._dispatchConfig(this._sidebarConfig))}_createSelectorOptions(e,t="list"){const i=is(this.hass);return{select:{multiple:!0,mode:t,options:e.map(e=>{const t=e===i;return{value:e,label:(rs(this.hass,e)||e)+(t?" (default)":"")}}),sort:!0,reorder:!0}}}_handleValueChange(e){e.stopPropagation();const t=e.target.configValue,i=e.target.customGroup,n=e.detail.value,o=!0===this._dialog._uncategorizedIsActive,s={...this._sidebarConfig||{}},r={};if([m.BOTTOM_ITEMS,m.BOTTOM_GRID_ITEMS].includes(t)){const e=t,i=[...s[e]||[]],a=n.filter(e=>!i.includes(e));let l=[...this._sidebarConfig[e]||[]];if(o&&a.length>0){let e=[...s.custom_groups?.[J.UNCATEGORIZED_ITEMS]||[]];e=e.filter(e=>!a.includes(e)),r.custom_groups={...this._sidebarConfig.custom_groups||{},[J.UNCATEGORIZED_ITEMS]:e}}l=n,r[e]=l}else if(t===h.CUSTOM_GROUPS){const e=i,t=[...s.custom_groups?.[e]||[]],a=n.filter(e=>!t.includes(e));let l={...this._sidebarConfig.custom_groups||{}},c=[...l[e]||[]];if(o&&a.length>0){let e=[...l[J.UNCATEGORIZED_ITEMS]||[]];e=e.filter(e=>!a.includes(e)),l[J.UNCATEGORIZED_ITEMS]=e}c=n,l[e]=c,r.custom_groups=l}Object.keys(r).length>0&&(this._sidebarConfig={...this._sidebarConfig,...r}),this._dispatchConfig(this._sidebarConfig),this.requestUpdate()}_dispatchConfig(e){const t=new CustomEvent("sidebar-changed",{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(t)}clickedPanelInPreview(e,t){t&&(t===m.BOTTOM_GRID_ITEMS||t===m.BOTTOM_ITEMS?(this._selectedTab=h.BOTTOM_PANELS,this._selectedGroup=null,this._selectedBottom=t===m.BOTTOM_GRID_ITEMS?m.BOTTOM_GRID_ITEMS:m.BOTTOM_ITEMS):(this._selectedTab=h.CUSTOM_GROUPS,this._selectedGroup=t))}static get styles(){return[super.styles,ue`
      ...
      `]}};Jd([ih({attribute:!1})],p_.prototype,"_sidebarConfig",void 0),Jd([ih({type:Boolean,reflect:!0,attribute:"invalid-config"})],p_.prototype,"invalidConfig",void 0),Jd([nh()],p_.prototype,"_colorConfigMode",void 0),Jd([nh()],p_.prototype,"_baseColorFromTheme",void 0),Jd([nh()],p_.prototype,"_previewPanels",void 0),Jd([nh()],p_.prototype,"_collapsedGroups",void 0),Jd([nh()],p_.prototype,"_ready",void 0),Jd([sh(".divider-preview")],p_.prototype,"_previewContainer",void 0),Jd([sh(".panels-list")],p_.prototype,"_panelsList",void 0),Jd([sh(".groups-container")],p_.prototype,"_groupsContainer",void 0),Jd([ah("a")],p_.prototype,"_itemAnchorList",void 0),p_=Jd([Qd("sidebar-dialog-preview")],p_);let g_=class extends Yp{constructor(){super(),this._sidebarConfig={},this._configSource="browser_storage",this._rawYaml="",this._handleBtnAction=async e=>{switch(e){case"download":let e=await su(this,"Enter the filename","sidebar-organizer","Download","Cancel");if(null===e)return;""===e&&(e=""+(T+"_"+(new Date).toISOString().replace(/:/g,"-").split(".",1).join()));const t=this._yamlText(),i=new Blob([t],{type:"application/x-yaml"}),n=URL.createObjectURL(i);It(n,`${e}.yaml`),setTimeout(()=>URL.revokeObjectURL(n),0);break;case"copy":navigator.clipboard.writeText(this._yamlText()).then(()=>{});break;case"delete":const o="Delete";await ou(this,H.CONFIRM_DELETE,o)&&([D.UI_CONFIG,D.PANEL_ORDER,D.COLLAPSE,D.HIDDEN_PANELS].forEach(e=>{Is(e)}),setTimeout(()=>{window.location.reload()},200))}}}updated(e){super.updated(e)}static get styles(){return ue`
      :host {
    ...
    `}render(){const e=pu.BTN_LABEL,t=this._sidebarConfig,i=0===Object.keys(t).length,n=Xe`<ha-alert alertType="info">${H.CONFIG_EMPTY}</ha-alert>`,o=this._editorValue(),s=this._yamlText();if("home_assistant_config"===this._configSource)return Xe`
        ${i?n:Qe}
      ...
      <div class="config-menu-wrapper">
        <div class="menu-info-icon-wrapper">
          <div class="move-sec">
            ...
            >
              <ha-icon-button slot="trigger" .path=${this._open?xp:Pp}> </ha-icon-button>
    ...
    `}_renderMenuContent(){const e=fo(w,[d.GENERAL]);return Xe`<div class="tip-content">
      ...
      `]}};Jd([ih()],m_.prototype,"value",void 0),Jd([nh()],m_.prototype,"_open",void 0),m_=Jd([Qd("sidebar-dialog-menu")],m_);const __={title:"Title",url_path:"URL Path",component_name:"Component Name",group:"Group",show_in_sidebar:"Hidden",notification:"Notification"};let b_=class extends _t{constructor(){super(...arguments),this.items=[],this.columns=[],this.hideHeader=!1,this.narrow=!1}createRenderRoot(){return this}render(){const e=Xe`
      <div class="item-row top">
        <div class="cell icon"></div>
        <div class="cell grows">${__.title}</div>
    ...
    `;return Xe` <div class="data-table">
      ...
      ${this.items.map(e=>{const t=!1===e.show_in_sidebar?Xe`<ha-icon icon="mdi:eye-off"></ha-icon>`:Qe,i=e.notification?Xe`<ha-icon icon="mdi:check"></ha-icon>`:Qe;return Xe`
        ...
        `})}
    </div>`}};Jd([ih({type:Array})],b_.prototype,"items",void 0),Jd([ih({attribute:!1})],b_.prototype,"columns",void 0),Jd([ih({attribute:!1})],b_.prototype,"itemActionRenderer",void 0),Jd([ih({type:Boolean,attribute:"hide-header"})],b_.prototype,"hideHeader",void 0),Jd([ih({type:Boolean,reflect:!0})],b_.prototype,"narrow",void 0),b_=Jd([Qd("so-data-item-table")],b_);const y_=ue`
  :host {
...
`.toString();let v_=class extends Yp{constructor(){super(h.ALL_ITEMS),this._showByGroup=!1,this._renderGroupActionDropdown=(e,t)=>{let i=["edit-items","preview-item"];e===h.CUSTOM_GROUPS&&t!==J.UNCATEGORIZED_ITEMS?i.push("divider","delete"):t===J.UNCATEGORIZED_ITEMS&&i.push("divider","uncategorized-as-group");const n=Su(i);return Xe`
      <ha-dropdown
        slot="icons"
        @click=${Rt}
    ...
    `;return e.expansionOptions?t?s:o:n}_handleActionGroupClick(e){if(e.stopPropagation(),!e.detail||void 0===e.detail.item?.value)return;const{section:t,groupName:i}=e.target,n=e.detail.item.value;iu(this,"group-action",{action:n,key:i,type:t})}_toggleExpansionPanels(e){if(!this._expansionPanels.length)return;let t=Array.from(this._expansionPanels);e&&(t=Array.from(this._expansionPanels).filter(t=>t.id===e));const i=t.some(e=>e.hasAttribute(n.EXPANDED));t.forEach(e=>{i?e.removeAttribute(n.EXPANDED):e.setAttribute(n.EXPANDED,"")})}_handleGroupByPanelType(e){if(e.stopPropagation(),!e.detail||void 0===e.detail.item?.value)return;const t=e.detail.item.value;this._showByGroup="groups"===t,window.localStorage.setItem(D.SHOW_BY_GROUP,String(this._showByGroup))}static get styles(){return[super.styles,ue`
      ...
      `]}};Jd([ih({attribute:!1})],v_.prototype,"_sidebarConfig",void 0),Jd([ah("ha-expansion-panel")],v_.prototype,"_expansionPanels",void 0),Jd([ih({attribute:!1})],v_.prototype,"_showByGroup",void 0),v_=Jd([Qd("so-panel-all")],v_);const w_=ue`
  :host > div {
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));
    gap: 16px;
  }
`.toString();var E_;!function(e){e.GROUPS="groups",e.ITEMS="items"}(E_||(E_={}));const A_={items:"Individual Items Configuration",groups:"Groups Configuration"},O_={items:"Select an item",groups:"Select a group"},S_={groups:"A group entry applies to all panels in the group.",items:"If a panel is included in a group with a visibility setting, the individual panel setting will be ignored in favor of the group setting."};let C_=class extends Yp{constructor(){super(h.VISIBILITY),this._selectedSection=b.HIDDEN_ITEMS,window.SoPanelVisibility=this}updated(e){e.has("_selectedSection")&&this._selectedSection===b.HIDDEN_ITEMS&&this._changeSelectorGridStyle()}async _changeSelectorGridStyle(){await new Promise(e=>setTimeout(e,50));const e=this.shadowRoot?.querySelector("ha-selector#selector-hidden_items")?.shadowRoot?.querySelector("ha-selector-select");e&&this._styleManager.addStyle(w_,e.shadowRoot||e)}get _visibilityTemplatesData(){const e=this._sidebarConfig?.visibility_templates||{};return{items:[...Array.from(Object.entries(e?.items||{})).map(([e,t])=>({name:e,value:t}))],groups:[...Array.from(Object.entries(e?.groups||{})).map(([e,t])=>({name:e,value:t}))]}}render(){const e=y.map(e=>({value:e,label:v[e]})),t=Xe` <ha-control-select
    ...
    `}_renderHiddenItems(){const e=this._sidebarConfig?.hidden_items||[],t=this._panelsWithoutNewItems,i=this._computeSelectorOptions(t,"list",!1,!1),n=Object.entries(e).map(([,e])=>e);return Xe` <div class="items-container" style="flex: none">
      ...
      ${Object.values(E_).map(t=>{const i=this._computeOptionsSelector(t),n=e[t];return this._renderTemplateConfig(t,this._createHaSelectorObject(i,n,t))})}
    `}_renderTemplateConfig(e,t){return Et({options:{header:A_[e],noStyle:!0,expanded:!0},content:t})}_createHaSelectorObject(e,t,i,n){const o={object:{label_field:"name",description_field:"value",multiple:!0,fields:{name:{label:O_[i]||"Name",selector:e,required:!1},value:{label:"Visibility Template",selector:{template:{preview:!0}},required:!1}}}};return Xe`<ha-selector
      .hass=${this.hass}
      .value=${t}
      .selector=${o}
      .required=${!1}
    ...
    `}_handleMenuValueChanged(e){e.stopPropagation();const t=e.detail.value||null,i=t||d.GENERAL,n=this._currSection;this._currSection=i,n===d.NEW_ITEMS&&i!==d.NEW_ITEMS&&this._dialogPreview._hightlightItem(null)}_renderConfigSection(){const e=this._currSection;return{[d.APPEARANCE]:this._renderBaseConfig(),[d.PANELS]:this._renderPanelConfig(),[d.NEW_ITEMS]:this._renderNewItemsConfig()}[e]||Xe``}_renderSidebarPreview(){const e={"--so-force-transparent-background":!0===this._sidebarConfig.force_transparent_background?"transparent":void 0};return Xe`
      <div id="sidebar-preview" style=${Kp(e)}>
    ...
    `}_renderDiagnosticRow(e,t){return Xe`<span>${e}: ${t?"yes":"no"}</span>`}_uploadConfigFile(){const e=document.createElement("input");e.type="file",e.accept=".yaml",e.style.display="none",e.onchange=()=>{const t=e.files?.[0];if(!t)return;this._uploading=!0;const i=new FileReader;i.onload=async e=>{try{const t=e.target?.result,i=Td.parse(t),n=await lr(i,this.hass,!0);if("object"!=typeof n||null===n)return;if(n.valid){this._invalidConfig=void 0,this._uploading=!1;if(!await ou(this,H.UPLOAD_SUCCESS_VALID_RELOAD,"OK"))return;if(this._sidebarConfig=i,"home_assistant_config"===this._configSource)return await this._saveHomeAssistantConfig(),void window.location.reload();const e=()=>new Promise(e=>{Cs(D.UI_CONFIG,this._sidebarConfig),localStorage.removeItem(D.PANEL_ORDER),localStorage.removeItem(D.HIDDEN_PANELS),e()});await e(),window.location.reload()}else this._invalidConfig=n,await ru(this,H.INVALID_UPLOADED_CONFIG),this._uploading=!1,this.requestUpdate()}catch(e){}},i.readAsText(t)},document.body.appendChild(e),e.click(),document.body.removeChild(e)}_handleSidebarChanged(e){e.stopPropagation();const t=e.detail;"home_assistant_config"===this._configSource&&e.target!==this._dialogCodeEditor&&(this._rawYaml=""),this._sidebarConfig=t}_handleRawYamlChanged(e){e.stopPropagation(),this._rawYaml=e.detail.yaml,"home_assistant_config"===this._configSource&&(this._mainDialog._saveDisabled=!1)}_sidebarConfigChanged(e){e.stopPropagation();const t=e.detail.config;this._sidebarConfig=t}_startHaConfigPolling(){window.clearInterval(this._haConfigPollTimer),this._haConfigPollTimer=void 0,"home_assistant_config"===this._configSource&&this._connected&&(this._haConfigPollTimer=window.setInterval(()=>this._checkHaConfigExternalChange(),3e4))}async _checkHaConfigExternalChange(){if("home_assistant_config"!==this._configSource)return;const e=new Dd(this.hass),t=await e.info(),i=this._lastLoadedHaConfigModified??this._haConfigInfo.last_modified,n=t.last_modified;if(!bp(i,n))return void(this._haConfigInfo=t);if(this._haConfigInfo=t,this._haDiagnostics={...this._haDiagnostics,...t},this._mainDialog._saveDisabled)return void await this._reloadHomeAssistantConfig();await ou(this,"The Home Assistant config file changed on disk and you have unsaved edits. Reload it now?","Reload","Later")&&await this._reloadHomeAssistantConfig()}_legacyFrontendResourceLoaded(){return Array.from(document.scripts).some(e=>e.src.includes("/hacsfiles/sidebar-organizer/sidebar-organizer.js"))}_formatLastModified(e){return e?new Date(1e3*e).toLocaleString():"unknown"}get pickedItems(){return Array.from(this._panelConfigMap.values()).flat()}get ungroupedItems(){const e=is(this.hass),t=new Set([...this.pickedItems,...this._sidebarConfig?.hidden_items||[],e]);return this._initCombiPanels.filter(e=>!t.has(e))}get uncategorizedFromCustom(){if(this._sidebarConfig[J.CUSTOM_GROUPS]&&!this._sidebarConfig[J.CUSTOM_GROUPS].hasOwnProperty(J.UNCATEGORIZED_ITEMS))return this._sidebarConfig[J.CUSTOM_GROUPS][J.UNCATEGORIZED_ITEMS]}get pickedWithoutUncategorizedFromCustom(){const e=this._sidebarConfig[J.CUSTOM_GROUPS]?.[J.UNCATEGORIZED_ITEMS]||[];return Array.from(this._panelConfigMap.values()).flat().filter(t=>!e.includes(t))}get uncategorizedItems(){const e=is(this.hass),t=this.uncategorizedFromCustom||[],i=this.pickedWithoutUncategorizedFromCustom,n=this._initCombiPanels.filter(t=>!i.includes(t)&&!(this._sidebarConfig.hidden_items||[]).includes(t)&&t!==e);return Array.from(new Set([...t,...n]))}_handleItemClicked(e){e.stopPropagation();const t=e.detail,i=this._getGroupOfPanel(t);this._dialogPanels&&this._dialogPanels.clickedPanelInPreview(t,i)}static get styles(){return[ue`
      ...
      `]}};Jd([ih({type:Boolean,reflect:!0,attribute:"fullscreen"})],x_.prototype,"fullscreen",void 0),Jd([ih({attribute:!1})],x_.prototype,"_mainDialog",void 0),Jd([ih({attribute:!1})],x_.prototype,"_initConfig",void 0),Jd([nh()],x_.prototype,"_connected",void 0),Jd([nh()],x_.prototype,"_sidebarConfig",void 0),Jd([nh()],x_.prototype,"_useConfigFile",void 0),Jd([nh()],x_.prototype,"_configSource",void 0),Jd([nh()],x_.prototype,"_tabState",void 0),Jd([nh()],x_.prototype,"_configLoaded",void 0),Jd([nh()],x_.prototype,"_currSection",void 0),Jd([nh()],x_.prototype,"_initPanelOrder",void 0),Jd([nh()],x_.prototype,"_initCombiPanels",void 0),Jd([nh()],x_.prototype,"_newItemMap",void 0),Jd([nh()],x_.prototype,"_newItems",void 0),Jd([nh()],x_.prototype,"_panelConfigMap",void 0),Jd([nh()],x_.prototype,"_pinnedGroupsMap",void 0),Jd([nh()],x_.prototype,"_settingItemMoved",void 0),Jd([nh()],x_.prototype,"_uncategorizedItemsGroup",void 0),Jd([nh()],x_.prototype,"_uncategorizedIsActive",void 0),Jd([nh()],x_.prototype,"_uploading",void 0),Jd([nh()],x_.prototype,"_invalidConfig",void 0),Jd([nh()],x_.prototype,"_haConfigErrors",void 0),Jd([nh()],x_.prototype,"_haConfigInfo",void 0),Jd([nh()],x_.prototype,"_haDiagnostics",void 0),Jd([nh()],x_.prototype,"_lastLoadedHaConfigModified",void 0),Jd([nh()],x_.prototype,"_rawYaml",void 0),Jd([nh()],x_.prototype,"_narrow",void 0),Jd([sh(c.COLORS)],x_.prototype,"_dialogColors",void 0),Jd([sh(c.PANELS)],x_.prototype,"_dialogPanels",void 0),Jd([sh(c.PREVIEW)],x_.prototype,"_dialogPreview",void 0),Jd([sh(c.CODE_EDITOR)],x_.prototype,"_dialogCodeEditor",void 0),Jd([sh(c.NEW_ITEMS)],x_.prototype,"_dialogNewItems",void 0),Jd([sh(c.MENU)],x_.prototype,"_dialogMenu",void 0),Jd([sh("#sidebar-config")],x_.prototype,"_configSection",void 0),x_=Jd([Qd("sidebar-organizer-config-dialog")],x_);let T_=window.matchMedia("(min-width: 1000px) and (max-width: 1440px)"),k_=class extends _t{constructor(){super(...arguments),this.large=!1,this._open=!1,this._configValid=!0,this._saveDisabled=!0,this._GUImode=!0}connectedCallback(){super.connectedCallback(),window._sidebarOrganizerDialog=this}disconnectedCallback(){super.disconnectedCallback(),window._sidebarOrganizerDialog=void 0}async showDialog(e){this._open=!0,this._params=e,this._initConfig=Qi(e.config),T_.matches&&(this.large=!0)}closeDialog(){return this._isConfigChanged?(this._handleClose(),!1):(this._open=!1,this._params=void 0,iu(this,"dialog-closed",{dialog:this.localName}),!0)}_dialogClosed(){this._params=void 0,this._open=!1,iu(this,"dialog-closed",{dialog:this.localName})}get _canSaveConfig(){return void 0===this._configDialog._invalidConfig||this._configValid&&0!==Object.keys(this._configDialog._sidebarConfig).length}get _isConfigChanged(){return!(!this._params||!this._configDialog||this._configDialog._useConfigFile)&&JSON.stringify(this._initConfig)!==JSON.stringify(this._configDialog._sidebarConfig)}async _handleClose(){await ou(this,H.CONFIG_CHANGED,"SAVE","DISCARD")?this._handleSaveConfig():(bo(this._initConfig)&&Ns()&&Kd(),this._dialogClosed())}_showSuccessToast(){yf(this,{message:"Sidebar Organizer config saved."})}async _handleSaveConfig(){if(!this._canSaveConfig)return console.warn("Cannot save config, it is not valid or has unsaved changes."),void yf(this,{message:"Cannot save config, it is not valid or has unsaved changes.",duration:5e3});if(this._configDialog._useConfigFile&&this._configValid)await this._configDialog._handleInvalidConfig("save"),this._showSuccessToast();else if("home_assistant_config"===this._configDialog._configSource&&this._configValid){if(!await this._configDialog._saveHomeAssistantConfig())return}const e=this._configDialog._sidebarConfig,t=this._configDialog._useConfigFile,i={config:e,configSource:this._configDialog._configSource,useConfigFile:t};iu(this,R.SIDEBAR_CONFIG_SAVED,i),this._dialogClosed()}_renderContent(){return Xe`
    ...
    `}};Jd([ih({attribute:!1})],k_.prototype,"hass",void 0),Jd([ih({type:Boolean,reflect:!0})],k_.prototype,"large",void 0),Jd([nh()],k_.prototype,"_params",void 0),Jd([nh()],k_.prototype,"_initConfig",void 0),Jd([nh()],k_.prototype,"_open",void 0),Jd([nh()],k_.prototype,"_configValid",void 0),Jd([nh()],k_.prototype,"_saveDisabled",void 0),Jd([nh()],k_.prototype,"_GUImode",void 0),Jd([sh("ha-dialog")],k_.prototype,"_dialog",void 0),Jd([sh("sidebar-organizer-config-dialog")],k_.prototype,"_configDialog",void 0),k_=Jd([Qd("sidebar-organizer-dialog")],k_);var N_=Object.freeze({__proto__:null,get SidebarOrganizerDialog(){return k_}});let $_=class extends _t{constructor(){super(...arguments),this.large=!1,this._open=!1,this._configValid=!0,this._saveDisabled=!0,this._GUImode=!0}connectedCallback(){super.connectedCallback(),window._sidebarOrganizerDialogWA=this}disconnectedCallback(){super.disconnectedCallback(),window._sidebarOrganizerDialogWA=void 0}async showDialog(e){this._open=!0,this._params=e,this.large=!1,this._initConfig=Qi(e.config),await this._watchDialogScroll()}closeDialog(){return this._isConfigChanged?(this._handleClose(),!1):(this._open=!1,this._params=void 0,iu(this,"dialog-closed",{dialog:this.localName}),!0)}_dialogClosed(){this._params=void 0,this._open=!1,iu(this,"dialog-closed",{dialog:this.localName})}get _canSaveConfig(){return void 0===this._configDialog._invalidConfig||this._configValid&&0!==Object.keys(this._configDialog._sidebarConfig).length}get _isConfigChanged(){return!(!this._params||!this._configDialog||this._configDialog._useConfigFile)&&JSON.stringify(this._initConfig)!==JSON.stringify(this._configDialog._sidebarConfig)}async _handleClose(){await ou(this,H.CONFIG_CHANGED,"SAVE","DISCARD")?this._handleSaveConfig():(bo(this._initConfig)&&Ns()&&Kd(),this._dialogClosed())}async _handleSaveConfig(){if(!this._canSaveConfig)return console.warn("Cannot save config, it is not valid or has unsaved changes."),void yf(this,{message:"Cannot save config, it is not valid or has unsaved changes.",duration:5e3});if(this._configDialog._useConfigFile&&this._configValid)await this._configDialog._handleInvalidConfig("save");else if("home_assistant_config"===this._configDialog._configSource&&this._configValid){if(!await this._configDialog._saveHomeAssistantConfig())return}const e=this._configDialog._sidebarConfig,t=this._configDialog._useConfigFile,i={config:e,configSource:this._configDialog._configSource,useConfigFile:t};iu(this,R.SIDEBAR_CONFIG_SAVED,i),this._dialogClosed()}_renderContent(){return Xe`
      <sidebar-organizer-config-dialog
    ...
    `}_toggleCodeUi(){this._configDialog._toggleCodeEditor(),this._GUImode=this._configDialog.GUImode}_enlarge(){this.large=!this.large}_ignoreKeydown(e){e.stopPropagation()}async _watchDialogScroll(){await kt();const e=this.shadowRoot?.querySelector("ha-dialog")?.shadowRoot?.querySelector("wa-dialog");if(e){const t=e.querySelector(".body");t&&(t.classList.remove("ha-scrollbar"),t.style.overflow="hidden")}}static get styles(){return[ue`
      ...
      `]}};Jd([ih({attribute:!1})],$_.prototype,"hass",void 0),Jd([ih({type:Boolean,reflect:!0})],$_.prototype,"large",void 0),Jd([nh()],$_.prototype,"_params",void 0),Jd([nh()],$_.prototype,"_initConfig",void 0),Jd([nh()],$_.prototype,"_open",void 0),Jd([nh()],$_.prototype,"_configValid",void 0),Jd([nh()],$_.prototype,"_saveDisabled",void 0),Jd([nh()],$_.prototype,"_GUImode",void 0),Jd([sh("sidebar-organizer-config-dialog")],$_.prototype,"_configDialog",void 0),$_=Jd([Qd("sidebar-organizer-dialog-wa")],$_);var L_=Object.freeze({__proto__:null,get SidebarOrganizerDialogWA(){return $_}});
